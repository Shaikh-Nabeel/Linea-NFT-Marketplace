...
const NFTModal = ({ nft, price, tokenId, contractAddress, owner, abi, isOpen, onClose }) => {
    ...
    const openLinkInNewTab = () => {
        const url = `https://edu-chain-testnet.blockscout.com/token/${contractAddress}/instance/${tokenId}`;
        ...
        try {
            ...
            toast.success('NFT bought successfully. Click to view', {
                ...
                onClick: function () {
                    ...
                    window.open("https://edu-chain-testnet.blockscout.com/tx/" + data, '_blank');
                }
            });
            setHash(data);
            setIsPending(null);
                    ...
                    <div className="flex-1 text-left">
                        ...
                        <div className="text-white font-semibold space-y-3 text-sm md:text-base">
                            ...
                            <div className="flex justify-between items-center md:mt-2">
                                ...
                                <span className="font-normal">EduChain Testnet</span>
                            </div>
                            <div className="flex justify-between items-center md:mt-2">
